    ...
    <VCol cols="12" md="4" sm="12">
      <VCard>
        <VCardItem>
          ...
          <VueApexCharts v-else class="float-center" :options="chartOptions" :series="series" />
        </VCardItem>
      </VCard>
    </VCol>
    <VCol cols="12">
                          ...
                          <v-row>
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField v-model="item.memiliki_kia" placeholder="Masukkan KIA"
                                    persistent-placeholder />
                                </VCol>
                              </VRow>
                            </VCol>
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField v-model="item.memiliki_kms" placeholder="Masukkan KMS"
                                    persistent-placeholder />
                                </VCol>
                              </VRow>
                            </VCol>
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField v-model="item.rt_rw" placeholder="Masukkan RT/RW" persistent-placeholder />
                                </VCol>
                              </VRow>
                            </VCol>
                            <VCol cols="12">
