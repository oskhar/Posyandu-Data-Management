...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      this.dataAdmin.foto_profile = this.imagePath + this.dataAdmin.foto_profile;
    },
          ...
          fileReader.onload = async () => {
            try {
              ...
              await Swal.fire({
                ...
                timer: 1500,
                icon: "error",
                title: "terjadi kesalahan saat upload gambar! gambar hanya boleh menggunakan jpeg, png, jpg",
              });
            }
          };
        }
