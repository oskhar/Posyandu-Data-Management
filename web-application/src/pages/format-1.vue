                          ...
                          <VRow>
                              ...
                              <VRow v-if="data_tersedia">
                                <VCol cols="12">
                                  <VRow no-gutters>
                                    ...
                                    <VCol cols="12" md="9">
                                      <VTextField
                                        id="ayah"
                                        v-model="dataFormatA[index].nama_ayah"
                                ...
                                <VCol cols="12">
                                  <VRow no-gutters>
                                    ...
                                    <VCol cols="12" md="9">
                                      <VTextField
                                        v-model="dataFormatA[index].nama_ibu"
                                        id="ibu"
                                ...
                                <VCol cols="12">
                                  <VRow no-gutters>
                                    ...
                                    <VCol cols="12" md="9">
                                      <VTextField
                                        v-model="dataFormatA[index].nik_ayah"
                                        id="nik_ayah"
                                ...
                                <VCol cols="12">
                                  <VRow no-gutters>
                                    ...
                                    <VCol cols="12" md="9">
                                      <VTextField
                                        v-model="dataFormatA[index].nik_ibu"
                                        id="nik_ibu"
                                ...
                                <VCol cols="12">
                                  <VRow no-gutters>
                                    ...
                                    <VCol cols="12" md="9">
                                      <VTextField
                                        v-model="dataFormatA[index].no_telp"
                                        placeholder="08xx"
                                        persistent-placeholder
                                      />
                                    </VCol>
                                ...
                                <VCol cols="12">
                                  <VRow no-gutters>
                                    ...
                                    <VCol cols="12" md="9">
                                      <VTextField
                                        v-model="dataFormatA[index].rt_rw"
                                  ...
                                  <VRow no-gutters>
                                    ...
                                    <VCol cols="12" md="9">
                                      <VTextarea
                                        ...
                                        v-model="
                                          dataFormatA[index].tempat_tinggal
                                        "
                                      />
                                    </VCol>
                                  </VRow>
                            ...
                            <VCol cols="12">
                              ...
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    v-model="dataFormatA[index].nama_bayi"
                                    id="bayi"
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    v-model="dataFormatA[index].nik_bayi"
                                    id="nik_bayi"
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    v-model="dataFormatA[index].anak_ke"
                                    type="number"
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VSelect
                                    v-model="dataFormatA[index].jenis_kelamin"
                                    :items="['L', 'P']"
                              ...
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    placeholder=""
                                    type="date"
                                    v-model="dataFormatA[index].tanggal_lahir"
                                  />
                                  <sup class="text-error">*Wajib diisi</sup>
                                </VCol>
                              </VRow>
                              ...
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    ...
                                    type="date"
                                    v-model="
                                      dataFormatA[index].tanggal_meninggal_bayi
                                    "
                                  />
                                </VCol>
                              </VRow>
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    v-model="dataFormatA[index].berat_lahir"
                                    type="number"
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    v-model="dataFormatA[index].tinggi_lahir"
                                    type="number"
                                    placeholder="Masukkan panjang Lahir..."
                                    persistent-placeholder
                                  />
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VCheckbox
                                    v-model="dataFormatA[index].memiliki_kia"
                                    :label="`Ya`"
                                  />
                                </VCol>
                              </VRow>
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VCheckbox
                                    v-model="dataFormatA[index].memiliki_kms"
                                    :label="`Ya`"
                                  />
                                </VCol>
                              </VRow>
                            ...
                            <VCol cols="12">
                              <VRow no-gutters>
                                ...
                                <VCol cols="12" md="9">
                                  <VTextField
                                    v-model="dataFormatA[index].keterangan"
