...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('bayi', function (Blueprint $table) {
            ...
            $table->integer('anak_ke')->nullable()->unsigned();
            $table->float('berat_lahir')->nullable()->unsigned();
            $table->float('tinggi_lahir')->nullable()->unsigned();
            $table->date('tanggal_lahir')->nullable();
            $table->date('tanggal_meninggal')->nullable();
            $table->boolean('imd')->nullable();
            $table->bigInteger('lulus_asi_eksklusif')->nullable()->unsigned();
