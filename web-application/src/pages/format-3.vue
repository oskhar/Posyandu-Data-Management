        ...
        <VCardItem>
          ...
          <VTable>
            ...
            <tbody>
              ...
              <tr
                v-for="(item, index) in dataFormatC"
                v-else
                :key="item.dessert"
              >
                <td>
                ...
                <td class="text-center">
                            ...
                            <VRow v-if="data_tersedia">
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="ibu"
                                      v-model="dataFormatC[index].nama_ibu"
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="nik_ayah"
                                      v-model="dataFormatC[index].nik_ayah"
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="nik_ibu"
                                      v-model="dataFormatC[index].nik_ibu"
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      v-model="
                                        dataFormatC[index].tanggal_meninggal_ibu
                                      "
                                      placeholder=""
                                      type="date"
                                    />
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      v-model="dataFormatC[index].no_telp"
                                      placeholder="08xx"
                                      persistent-placeholder
                                    />
                                  </VCol>
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      v-model="dataFormatC[index].rt_rw"
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextarea
                                      v-model="
                                        dataFormatC[index].tempat_tinggal
                                      "
                            ...
                            <VRow>
                              <VCol cols="12">
                                ...
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="umur"
                                      v-model="dataFormatC[index].umur"
                                      placeholder="tahun.."
                                      persistent-placeholder
                                      type="number"
                                    />
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="ks"
                                      v-model="dataFormatC[index].tahapan_ks"
                                ...
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="dasawisma"
                                      v-model="
                                        dataFormatC[index].kelompok_dasawisma
                                      "
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="lila"
                                      v-model="dataFormatC[index].lila"
                                      placeholder="cm.."
                                      persistent-placeholder
                                      type="number"
                                    />
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="6" md="4">
                                    <VTextField
                                      v-model="
                                        dataFormatC[index].jumlah_anak_hidup
                                      "
                                      placeholder="Hidup.."
                                    />
                                    <sup class="text-error">*Wajib diisi</sup>
                                  ...
                                  <VCol cols="6" class="ml-5" md="4">
                                    <VTextField
                                      v-model="
                                        dataFormatC[index].jumlah_anak_meninggal
                                      "
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VSelect
                                      v-model="dataFormatC[index].imunisasi"
                                      :items="itemImunisasi"
                                      label="imunisasi"
                              ...
                              <VCol cols="12">
                                <VRow no-gutters>
                                  <!-- 👉 First Name -->
                                  <VCol cols="12" md="3">
                                    <label for="kontrasepsi"
                                      >Jenis Kontrasepsi</label
                                    >
                                  </VCol>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="kontrasepsi"
                                      v-model="
                                        dataFormatC[index].jenis_kontrasepsi
                                      "
                                      placeholder="jenis.."
                                      persistent-placeholder
                                    />
                                ...
                                <VRow no-gutters>
                                  ...
                                  <VCol cols="12" md="9">
                                    <VTextField
                                      id="penggantian"
                                      v-model="
                                        dataFormatC[index].tanggal_penggantian
                                      "
                  ...
                  <VBtn
                    class="ml-2"
                    color="error"
                    @click="deleteData(item.id_format_c)"
                  >
