...
<template>
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <v-col cols="12" md="12" style="max-width: 380">
        <div class="card-tiga">
          ...
          >
            ...
            <center>
              <svg
                ...
                height="224"
                viewBox="0 0 24 24"
                style="fill: rgba(84, 104, 255, 1); transform: ; msfilter; "
              >
                <path
            ...
            >
              <p style="margin: 0px; font-size: 20px">JUMLAH EDUKASI</p>
            </h2>
          </v-card>
          ...
          >
            ...
            <center>
              <svg
                ...
                height="224"
                viewBox="0 0 24 24"
                style="fill: rgba(84, 104, 255, 1); transform: scaleY(-1)"
              >
                <path
            ...
            <h2 class="text-center">
              <p style="margin: 0px; font-size: 20px">JUMLAH BERITA & ACARA</p>
            </h2>
          </v-card>
