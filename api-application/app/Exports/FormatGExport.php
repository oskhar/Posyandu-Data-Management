...
class LaporanGExport implements FromCollection, WithEvents, WithCustomStartCell, WithStyles
{
    ...
    public function collection()
    {
        ...
        $result->push([
            ...
            empty($SP[3]) ? '-' : $SP[3],
            empty($S[3]) ? '-' : $S[3],
            empty($SL[0] + $SL[1] + $SL[2] + $SL[3]) ? '-' : $SL[0] + $SL[1] + $SL[2] + $SL[3],
            empty($SP[0] + $SP[1] + $SP[2] + $SP[3]) ? '-' : $SP[0] + $SP[1] + $SP[2] + $SP[3],
            empty($S[0] + $S[1] + $S[2] + $S[3]) ? '-' : $S[0] + $S[1] + $S[2] + $S[3],
        ]);
        $result->push([
            "K",
            empty($KL[0]) ? '-' : $KL[0],
            ...
            empty($KP[3]) ? '-' : $KP[3],
            empty($K[3]) ? '-' : $K[3],
            empty($KL[0] + $KL[1] + $KL[2] + $KL[3]) ? '-' : $KL[0] + $KL[1] + $KL[2] + $KL[3],
            empty($KP[0] + $KP[1] + $KP[2] + $KP[3]) ? '-' : $KP[0] + $KP[1] + $KP[2] + $KP[3],
            empty($K[0] + $K[1] + $K[2] + $K[3]) ? '-' : $K[0] + $K[1] + $K[2] + $K[3],
        ]);
        $result->push([
            "N",
            empty($NL[0]) ? '-' : $NL[0],
            ...
            empty($NP[3]) ? '-' : $NP[3],
            empty($N[3]) ? '-' : $N[3],
            empty($NL[0] + $NL[1] + $NL[2] + $NL[3]) ? '-' : $NL[0] + $NL[1] + $NL[2] + $NL[3],
            empty($NP[0] + $NP[1] + $NP[2] + $NP[3]) ? '-' : $NP[0] + $NP[1] + $NP[2] + $NP[3],
            empty($N[0] + $N[1] + $N[2] + $N[3]) ? '-' : $N[0] + $N[1] + $N[2] + $N[3],
        ]);
        $result->push([
            "T",
            empty($TL[0]) ? '-' : $TL[0],
            ...
            empty($TP[3]) ? '-' : $TP[3],
            empty($T[3]) ? '-' : $T[3],
            empty($TL[0] + $TL[1] + $TL[2] + $TL[3]) ? '-' : $TL[0] + $TL[1] + $TL[2] + $TL[3],
            empty($TP[0] + $TP[1] + $TP[2] + $TP[3]) ? '-' : $TP[0] + $TP[1] + $TP[2] + $TP[3],
            empty($T[0] + $T[1] + $T[2] + $T[3]) ? '-' : $T[0] + $T[1] + $T[2] + $T[3],
        ]);
        $result->push([
            "O",
            empty($OL[0]) ? '-' : $OL[0],
            ...
            empty($OP[3]) ? '-' : $OP[3],
            empty($O[3]) ? '-' : $O[3],
            empty($OL[0] + $OL[1] + $OL[2] + $OL[3]) ? '-' : $OL[0] + $OL[1] + $OL[2] + $OL[3],
            empty($OP[0] + $OP[1] + $OP[2] + $OP[3]) ? '-' : $OP[0] + $OP[1] + $OP[2] + $OP[3],
            empty($O[0] + $O[1] + $O[2] + $O[3]) ? '-' : $O[0] + $O[1] + $O[2] + $O[3],
        ]);
        $result->push([
            "B",
            empty($BL[0]) ? '-' : $BL[0],
            ...
            empty($BP[3]) ? '-' : $BP[3],
            empty($B[3]) ? '-' : $B[3],
            empty($BL[0] + $BL[2] + $BL[2] + $BL[3]) ? '-' : $BL[0] + $BL[2] + $BL[2] + $BL[3],
        ...
        $result->push([
            ...
            empty($STP[2]) ? '-' : $STP[2],
            empty($ST[2]) ? '-' : $ST[2],
            empty($STL[0] + $STL[1] + $STL[2] + $STL[3]) ? '-' : $STL[0] + $STL[1] + $STL[2] + $STL[3],
            empty($STP[0] + $STP[1] + $STP[2] + $STP[3]) ? '-' : $STP[0] + $STP[1] + $STP[2] + $STP[3],
            empty($ST[0] + $ST[1] + $ST[2] + $ST[3]) ? '-' : $ST[0] + $ST[1] + $ST[2] + $ST[3],
        ]);
        $result->push([
            "2T",
            empty($TTL[0]) ? '-' : $TTL[0],
            ...
            empty($TTP[3]) ? '-' : $TTP[3],
            empty($TT[3]) ? '-' : $TT[3],
            empty($TTL[0] + $TTL[1] + $TTL[2] + $TTL[3]) ? '-' : $TTL[0] + $TTL[1] + $TTL[2] + $TTL[3],
            empty($TTP[0] + $TTP[1] + $TTP[2] + $TTP[3]) ? '-' : $TTP[0] + $TTP[1] + $TTP[2] + $TTP[3],
            empty($TT[0] + $TT[1] + $TT[2] + $TT[3]) ? '-' : $TT[0] + $TT[1] + $TT[2] + $TT[3],
        ]);
        $result->push([
            "D-O-B",
            empty($DOBL[0]) ? '-' : $DOBL[0],
            ...
            empty($DOBP[3]) ? '-' : $DOBP[3],
            empty($DOB[3]) ? '-' : $DOB[3],
            empty($DOBL[0] + $DOBL[1] + $DOBL[2] + $DOBL[3]) ? '-' : $DOBL[0] + $DOBL[1] + $DOBL[2] + $DOBL[3],
            empty($DOBP[0] + $DOBP[1] + $DOBP[2] + $DOBP[3]) ? '-' : $DOBP[0] + $DOBP[1] + $DOBP[2] + $DOBP[3],
            empty($DOB[0] + $DOB[1] + $DOB[2] + $DOB[3]) ? '-' : $DOB[0] + $DOB[1] + $DOB[2] + $DOB[3],
        ]);
        $result->push([
            "BGM",
            empty($BGML[0]) ? '-' : $BGML[0],
            ...
            empty($BGMP[3]) ? '-' : $BGMP[3],
            empty($BGM[3]) ? '-' : $BGM[3],
            empty($BGML[0] + $BGML[1] + $BGML[2] + $BGML[3]) ? '-' : $BGML[0] + $BGML[1] + $BGML[2] + $BGML[3],
            empty($BGMP[0] + $BGMP[1] + $BGMP[2] + $BGMP[3]) ? '-' : $BGMP[0] + $BGMP[1] + $BGMP[2] + $BGMP[3],
            empty($BGM[0] + $BGM[1] + $BGM[2] + $BGM[3]) ? '-' : $BGM[0] + $BGM[1] + $BGM[2] + $BGM[3],
        ]);
        $result->push([
            "VIT A",
            empty($VAL[0]) ? '-' : $VAL[0],
            ...
            empty($VAP[3]) ? '-' : $VAP[3],
            empty($VA[3]) ? '-' : $VA[3],
            empty($VAL[0] + $VAL[1] + $VAL[2] + $VAL[3]) ? '-' : $VAL[0] + $VAL[1] + $VAL[2] + $VAL[3],
            empty($VAP[0] + $VAP[1] + $VAP[2] + $VAP[3]) ? '-' : $VAP[0] + $VAP[1] + $VAP[2] + $VAP[3],
            empty($VA[0] + $VA[1] + $VA[2] + $VA[3]) ? '-' : $VA[0] + $VA[1] + $VA[2] + $VA[3],
        ]);
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use ($query) {
                ...
                $event->sheet->setCellValue('N5', 'L');
                $event->sheet->setCellValue('O5', 'P');
                $event->sheet->setCellValue('P5', 'JML');
