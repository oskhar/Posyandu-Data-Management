<template>
    <VRow>
        <VCol cols="12">
            <VCard>
                <VProgressCircular v-if="isLoadingSekali" indeterminate color="primary" class="mt-5 float-center"
                    size="50">
                </VProgressCircular>
            ...
            <VCard>
                ...
                <VCardItem>
                    <VRow>
                        ...
                        <VCol cols="12">
                            <VBtn class="ml-4 mb-3" href="/admin/data/format-4-create" prepend-icon="bx-plus">
                                Tambah
                            </VBtn>
                            <VBtn class="ml-4 mb-3" prepend-icon="bx-download" @click="exportExcel">
                                Download
                            </VBtn>
                        </VCol>
                    </VRow>
                    <VTable>
                        ...
                        <tbody>
                            ...
                            <tr v-for="(item, index) in dataFormatD" v-else :key="item.dessert">
                                ...
                                <td class="text-center">
                                    <VDialog v-model="dialog[item.id_format_d]" persistent width="1024">
                                        ...
                                        <VCard>
                                                    ...
                                                    <VRow>
                                                            ...
                                                            <VRow class="mb-5">
                                                                <VCol cols="12" md="4" lg="4">
                                                                    <VRadioGroup v-model="data_tersedia">
                                                                        <VRadio label="Ubah data" :value="true">
                                                                        </VRadio>
                                                                    </VRadioGroup>
                                                                </VCol>
                                                                <VCol cols="12" md="4" lg="4">
                                                            ...
                                                            <VRow v-if="data_tersedia">
                                                                ...
                                                                <VCol cols="12">
                                                                    <VRow no-gutters>
                                                                        ...
                                                                        <VCol cols="12" md="9">
                                                                            <VTextField
                                                                                v-model="dataFormatD[index].no_telp"
                                                                                placeholder="08xx"
                                                                                persistent-placeholder />
                                                                        </VCol>
                                                                    </VRow>
                                                                ...
                                                                <VCol cols="12">
                                                                    <VRow no-gutters>
                                                                        ...
                                                                        <VCol cols="12" md="9">
                                                                            <VTextField
                                                                                v-model="dataFormatD[index].rt_rw"
                                                        ...
                                                        <VCol cols="12">
                                                            ...
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VTextField id="bayi"
                                                                        v-model="dataFormatD[index].nama_bayi"
                                                        ...
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VTextField id="nik_bayi"
                                                                        v-model="dataFormatD[index].nik_bayi"
                                                        ...
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VTextField v-model="dataFormatD[index].anak_ke"
                                                                        type="number"
                                                                        placeholder="Masukkan panjang Lahir..."
                                                                        persistent-placeholder />
                                                                </VCol>
                                                            </VRow>
                                                        </VCol>
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VSelect v-model="dataFormatD[index].jenis_kelamin"
                                                                        :items="['L', 'P']"
                                                        ...
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VTextField
                                                                        v-model="dataFormatD[index].tanggal_lahir"
                                                                        placeholder="" type="date" />
                                                                    <sup class="text-error">*Wajib diisi</sup>
                                                                </VCol>
                                                            </VRow>
                                                        ...
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                <!-- 👉 First Name -->
                                                                <VCol cols="12" md="3">
                                                                    <label for="tanggal-meninggal-bayi">Tanggal
                                                                        Meninggal
                                                                        Bayi</label>
                                                                </VCol>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VTextField
                                                                        v-model="dataFormatD[index].tanggal_meninggal_bayi"
                                                                        placeholder="" type="date" />
                                                                </VCol>
                                                            </VRow>
                                                        </VCol>
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VTextField v-model="dataFormatD[index].berat_lahir"
                                                                        type="number"
                                                        ...
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VTextField
                                                                        v-model="dataFormatD[index].tinggi_lahir"
                                                                        type="number"
                                                                        placeholder="Masukkan panjang Lahir..."
                                                                        persistent-placeholder />
                                                                </VCol>
                                                        ...
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VCheckbox v-model="dataFormatD[index].memiliki_kia"
                                                                        label="Ya" />
                                                                </VCol>
                                                            </VRow>
                                                        </VCol>
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VCheckbox v-model="dataFormatD[index].imd"
                                                                        label="Ya" />
                                                                </VCol>
                                                            </VRow>
                                                        </VCol>
                                                        <VCol cols="12">
                                                            <VRow no-gutters>
                                                                ...
                                                                <VCol cols="12" md="9">
                                                                    <VCheckbox v-model="dataFormatD[index].memiliki_kms"
                                                                        label="Ya" />
                                                                </VCol>
                                                            </VRow>
                                                        </VCol>
                                            ...
                                            <VCardActions>
                                                ...
                                                <VBtn color="blue-darken-1" variant="text"
                                                    @click="dialog[item.id_format_d] = false">
                                                    Tutup
                                                </VBtn>
                                                <VBtn color="blue-darken-1" variant="text" @click="
                                                    putData(index);
                                                dialog[item.id_format_d] = false;
                                                ">
                                                    Simpan
                                                </VBtn>
                                            </VCardActions>
...
export default {
    ...
    async mounted() {
        ...
        this.judulFormatD = response.data.judul_format;
    ...
    methods: {
        ...
        async exportExcel() {
            const response = await axios({
                method: "get",
                url: `${this.urlServer}/api/export/format-d?tahun=${this.tahun}`,
                responseType: "blob",
                headers: {
                    Authorization: localStorage.getItem("tokenAuth"),
                },
        ...
        async fetchData() {
            ...
            const response = await axios.get(
                `${config.urlServer}/api/format-d?length=20&start=${this.page}&tahun=${this.tahun}&search=${this.dataSearch}`,
                {
                    headers: {
                        Authorization: localStorage.getItem("tokenAuth"),
                    },
            ...
            this.dataFormatD = response.data.format_a;
            this.jumlahData = response.data.jumlah_data;
